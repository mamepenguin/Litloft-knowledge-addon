 ...
 * drive catalogue (`index`) is the only switch, and the host already
 * omits the slot when it is off.
 */
export default function ClipWebPageMenuItem({
  ...
  return (
    <>
      <ActionMenuItem icon={Globe} label={t("menuItem")} onClick={handleOpen} />
      {open && (
        <ClipWebPageDialog
          drive={drive}
          path={path}
